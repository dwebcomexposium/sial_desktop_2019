...
(function($) {
     ...
     * Background image
     */
        $('.hero__img').each(function(i, item) {
     ...
     */        var nowDate = new Date();
        ...
        var counter = {
            months: $('.hero__counter__number.months'),
            days: $('.hero__counter__number.days'),
            hours: $('.hero__counter__number.hours'),
            minutes: $('.hero__counter__number.minutes'),
            percent: $('.hero__counter__progressbar__inner')
        };
     ...
     */        var parallaxOptions = {
        ...
        var parallaxTitle = new Rellax('.js .hero__title', parallaxOptions);
        var parallaxCounter = new Rellax('.js .hero__counter', parallaxOptions);
    });
})(jQuery);
