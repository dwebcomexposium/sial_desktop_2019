    ...
    $(function() {
        if ($('body').hasClass('exhibitor-details')) {
            ...
            groups.each(function(group) {
                var $that = $(this);
                $($that).on('click mousedown touchstart', '.js-hide-trigger', function() {
                    $($that).find('.js-hide-item').toggle();
                    $(this).find('.js-hide-trigger-txtShow').toggle();
                    $(this).find('.js-hide-trigger-txtHide').toggle();
                    return false;
                });
            });
